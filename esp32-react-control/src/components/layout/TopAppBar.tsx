...
export function TopAppBar({ status, activeTab, setActiveTab }: TopAppBarProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full z-50 h-[calc(4rem+env(safe-area-inset-top))] pt-[env(safe-area-inset-top)] clay-card-dark rounded-b-3xl rounded-t-none flex items-center px-margin-mobile md:px-8 shadow-[0_8px_24px_rgba(0,0,0,0.4)]">
